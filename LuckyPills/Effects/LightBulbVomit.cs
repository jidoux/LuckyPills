...
internal record LightBulbVomit : PillEffect {
	...
	protected override string DisplayText { get; } = "You've been given light bulb vomit for {duration} seconds";
	...
	protected override void OnEnabled(Player player, float duration) {
		...
		MEC.Timing.RunCoroutine(Grenades.RunGrenadeVomit(player, duration, _grenadesPerSecond, ItemType.SCP2176));
	}
}
